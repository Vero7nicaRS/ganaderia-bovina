...
export const FormularioVT_Animales= () => {
    ...
    const validarFormulario = () => {
        const erroresTemp = ComprobarCamposFormularioVT(vt_animal); // Revisa todos los campos
                ...
                <div className="cuadradoVisualizarAgregarmodificarVT_Animal">
                    {esVisualizar
                        ...
                        : esAgregar
                            ...
                            : `MODIFICAR ${vt_animal.tipo.toUpperCase()} DEL INVENTARIO`}
                </div>
            ...
            <form>
                    ...
                    <div className="contenedor-derecha">
                        ...
                        <div className="contenedor-linea">
                            ...
                            {errores.fechaInseminacion &&
                                <div className="mensaje-error">{errores.fechaInseminacion}</div>}
                        ...
                        <div className="contenedor-linea">
                            ...
                            <input
                                ...
                                onChange={(e) => setVT_Animal({...vt_animal, horaInseminacion: e.target.value})}
                            ...
                            {errores.horaInseminacion &&
                                <div className="mensaje-error">{errores.horaInseminacion}</div>}
                ...
                <>
                    ...
                    {esVisualizar && (
                        ...
                        <div className="boton-espacio">
                        <NavLink to="/listado-vt-animal" className="btn btn-info">VISUALIZAR OTROS TRATAMIENTOS/VACUNAS DEL INVENTARIO</NavLink>
                        </div>
                    )}
                </>
